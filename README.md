<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 950 900" width="100%" height="100%">
    <defs>
        <!-- Light Ocean to Grassland Theme Gradients & Filters -->
        <linearGradient id="bg-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stop-color="#E0F2FE"/> <!-- Light Ocean/Sky Blue -->
            <stop offset="50%" stop-color="#CCFBF1"/> <!-- Soft Mint/Aqua -->
            <stop offset="100%" stop-color="#DCFCE7"/> <!-- Light Grass Green -->
        </linearGradient>

        <linearGradient id="text-grad" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stop-color="#0284C7"/> <!-- Deep Ocean Blue -->
            <stop offset="100%" stop-color="#059669"/> <!-- Forest/Grass Green -->
        </linearGradient>
    ...
    <!-- Decorative Glowing Orbs (Light Ocean & Grass Vibes) -->
